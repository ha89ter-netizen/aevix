...
const MESSAGES: Record<string, string> = {
  ...
  // Почта не подтверждена: пароль на таком адресе мог задать не владелец, поэтому он не
  // открывает аккаунт. Код из письма подтверждает владение — и это единственный честный путь.
  unverified: "Почта ещё не подтверждена. Войдите по коду из письма — он подтвердит адрес.",
};
