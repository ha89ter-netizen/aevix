...
/** Reads the request as a designer would: what is being asked of the design, not which keyword. */
export function resolveIntent(request: string): { id: DesignerIntentId; value?: string } {
...
/** Applies one bounded edit to the project's concept. */
export function applyDesignerRequest(request: string, project: Project): DesignerOutcome {
